...
export default function WidgetCard({ widget, isLearned, onClick }) {
  const getCategoryClass = (category) => {
    switch (category) {
      case 'الهيكل والترتيب':
        return 'cat-structure';
      case 'العناصر الأساسية':
        return 'cat-basic';
      case 'التصميم والتنسيق':
        return 'cat-styling';
      default:
        return 'cat-default';
    }
  ...
  return (
    ...
    >
      <div className="card-top">
        ...
        {isLearned ? (
          <span className="learned-badge" title="تم إنهاء تعلم هذا العنصر">
          ...
          <span className="pending-badge">قيد التعلم</span>
        )}
      </div>
